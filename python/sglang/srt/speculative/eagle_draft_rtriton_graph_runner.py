...
class EAGLEDraftRtritonGraphRunner:
    def __init__(self, eagle_worker: EAGLEWorker):
        ...
        self.model_runner.draft_attn_backend.init_rtriton_graph_state(
    ...
    def capture_one_batch_size(
        ...
        # Attention backend
        self.model_runner.draft_attn_backend.init_forward_metadata_capture_rtriton_graph(
            forward_batch
        )
    ...
    def replay(self, forward_batch: ForwardBatch):
        ...
        self.model_runner.draft_attn_backend.init_forward_metadata_replay_rtriton_graph(
            forward_batch, bs
        )
        self.raw_bs = raw_bs
        self.bs = bs
        # TODO: The forward_batch.seq_len_sum might need to be updated to reflect the padding in the rtriton graph
