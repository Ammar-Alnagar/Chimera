...
class EAGLEDraftExtendRtritonGraphRunner:
    def __init__(self, eagle_worker: EAGLEWorker):
        ...
        self.eagle_worker.draft_extend_attn_backend.init_rtriton_graph_state(
            self.max_bs, self.max_num_token
        )
        self.seq_len_fill_value = (
            self.eagle_worker.draft_extend_attn_backend.get_rtriton_graph_seq_len_fill_value()
        )
    ...
    def capture_one_batch_size(self, bs: int, forward: Callable, stream_idx: int = 0):
        ...
        self.eagle_worker.draft_extend_attn_backend.init_forward_metadata_capture_rtriton_graph(
            bs=bs,
    ...
    def replay(self, forward_batch: ForwardBatch):
        ...
        self.eagle_worker.draft_extend_attn_backend.init_forward_metadata_replay_rtriton_graph(
            bs=bs,
