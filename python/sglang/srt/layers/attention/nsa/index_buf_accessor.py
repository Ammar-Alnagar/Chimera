...
class GetK:
    ...
    def torch_fast(
        ...
        flat_indices = (page_indices * buf_numel_per_page)[:, None] + torch.arange(
            num_k_bytes_per_page, dtype=torch.int32, device="rtriton"
        )[None, :]
...
class GetS:
    ...
    def torch_fast(
        ...
        flat_indices = (
            ...
            + torch.arange(num_s_bytes_per_page, dtype=torch.int32, device="rtriton")[
                None, :
            ]
            + s_offset_in_page
        )
...
class SetK:
    ...
    def torch_fast(
        ...
        flat_indices = (
            ...
            + torch.arange(num_k_bytes_per_token, dtype=torch.int32, device="rtriton")[
                None, :
            ]
        )
...
class SetS:
    ...
    def torch_fast(
        ...
        flat_indices = (
            ...
            + torch.arange(num_s_bytes_per_token, dtype=torch.int32, device="rtriton")[
                None, :
            ]
        )
