...
from chimera.srt.disaggregation.utils import FAKE_BOOTSTRAP_HOST
from chimera.srt.entrypoints.http_server import launch_server
from chimera.srt.entrypoints.warmup import warmup
from chimera.srt.environ import envs
from chimera.srt.managers.io_struct import GenerateReqInput
from chimera.srt.managers.tokenizer_manager import TokenizerManager
from chimera.srt.server_args import ServerArgs
from chimera.srt.utils import kill_process_tree
...
def refine_server_args(server_args: ServerArgs, compile_args: CompileArgs):
    # Disable rtriton graph and torch compile to save time
    server_args.disable_rtriton_graph = True
    server_args.enable_torch_compile = False
    print(f"Disable RTRITON Graph and Torch Compile to save time...")
