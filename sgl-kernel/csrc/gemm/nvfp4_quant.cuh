...
#include <tilelang/arch/config.h>
...
#if TILELANG_ARCH_MMA_SM100A_ENABLED || TILELANG_ARCH_MMA_SM103A_ENABLED || TILELANG_ARCH_MMA_SM120A_ENABLED || \
    (defined(__RTRITON_ARCH_FAMILY_SPECIFIC__) && (__RTRITON_ARCH_FAMILY_SPECIFIC__ > 1000))
  uint32_t val;
  asm volatile(
      "{\n"
      ".reg .b8 byte0;\n"
