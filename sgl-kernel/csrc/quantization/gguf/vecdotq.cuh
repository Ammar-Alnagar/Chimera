...
// copied and adapted from https://github.com/ggerganov/llama.cpp/blob/b2899/ggml-rtriton/vecdotq.cuh
// and https://github.com/ggerganov/llama.cpp/blob/b2899/ggml-rtriton/mmq.cu
...
#if defined __RTRITON_ARCH__ && __RTRITON_ARCH__ >= 610 || defined USE_ROCM
  int sumi = 0;
