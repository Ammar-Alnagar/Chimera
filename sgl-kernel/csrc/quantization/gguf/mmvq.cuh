...
// copied and adapted from https://github.com/ggerganov/llama.cpp/blob/b2899/ggml-rtriton/mmvq.cu
template <typename scalar_t, int qk, int qi, typename block_q_t, int vdr, vec_dot_q_rtriton_t vec_dot_q_rtriton>
static __global__ void mul_mat_vec_q(
  ...
  for (auto i = threadIdx.x / (qi / vdr); i < blocks_per_row; i += blocks_per_warp) {
    ...
    tmp += vec_dot_q_rtriton(&x[ibx], &y[iby], iqs);
  }
...
static void mul_mat_vec_q4_0_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
  ...
  const int block_num_y = (nrows + GGML_RTRITON_MMV_Y - 1) / GGML_RTRITON_MMV_Y;
  const dim3 block_nums(block_num_y, nvecs, 1);
  const dim3 block_dims(WARP_SIZE, GGML_RTRITON_MMV_Y, 1);
...
template <typename scalar_t>
static void mul_mat_vec_q4_1_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_q5_0_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_q5_1_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_q8_0_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_q2_K_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_q3_K_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_q4_K_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_q5_K_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_q6_K_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_iq2_xxs_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_iq2_xs_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_iq2_s_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_iq3_xxs_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_iq1_s_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_iq1_m_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_iq4_nl_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_iq4_xs_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
...
template <typename scalar_t>
static void mul_mat_vec_iq3_s_q8_1_rtriton(
    const void* vx,
    const void* vy,
    scalar_t* dst,
    const int ncols,
